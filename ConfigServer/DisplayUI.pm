...
EOF
		...
		# Removed 2026-08-14: three promotional panels offering cxs, osm and
		# msfe. All three were discontinued with the company on 2025-08-31 and
		# the pages they linked to are gone, so the UI was advertising software
		# that cannot be obtained. The copyright notices elsewhere in this file
		# are a different matter and are left untouched.
		print "</table>\n";
		print "</form>\n";
