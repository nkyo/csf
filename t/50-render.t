...
# itself) on every file.
{
	...
	is_deeply(\@all_findings, [],
		...
		or diag("Found a problem:\n  " . join("\n  ", @all_findings) . "\n\n"
			...
			. "instead (value= is on the inert allowlist - R51; ui-src/web/screens/lists.html's own header "
			. "comment has the worked example and says what to do if this pattern does not fit your case); "
			. "server-rendered HTML should not have inline event-handler attributes at all, and per "
